...
public class InputChoiceFragment extends Fragment {
     ...
     */
    public InputChoiceFragment() {
    }

    public static InputChoiceFragment newInstance() {
        return new InputChoiceFragment();
    }
