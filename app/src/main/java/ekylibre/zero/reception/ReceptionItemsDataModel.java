...
public class ReceptionItemsDataModel {
    ...
    public ReceptionItemsDataModel(int id, ReceptionDataModel fk_reception, ArticleDataModel article, double quantity, int ek_id) {
        this.id = id;
        this.fk_reception = article.getId() ;
